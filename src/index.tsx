...
export function bootstrap(props: unknown): Promise<void> {
  return reactLifecycles
    .bootstrap(props)
    .then(() => {
      log.info('frontend has been successfully bootstrapped');
    })
    .catch((error: unknown) => {
      log.error('frontend failed whilst bootstrapping: ' + error);
    });
}
...
export function mount(props: unknown): Promise<void> {
  return reactLifecycles
    .mount(props)
    .then(() => {
      log.info('frontend has been successfully mounted');
    })
    .catch((error: unknown) => {
      log.error('frontend failed whilst mounting: ' + error);
    });
}
...
export function unmount(props: unknown): Promise<void> {
  return reactLifecycles
    .unmount(props)
    .then(() => {
      log.info('frontend has been successfully unmounted');
    })
    .catch((error: unknown) => {
      log.error('frontend failed whilst unmounting: ' + error);
    });
}
